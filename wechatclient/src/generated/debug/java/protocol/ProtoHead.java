...
public final class ProtoHead {
  ...
  public enum ENetworkMessage
    ...
    public static ENetworkMessage forNumber(int value) {
      switch (value) {
    ...
    private ENetworkMessage(int value) {
      this.value = value;
    }
