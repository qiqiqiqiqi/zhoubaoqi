...
public class ChatFunctionFragment extends BaseFragment implements View.OnClickListener {
    ...
    private TextView mChatFunctionPhoto;
    private TextView mChatFunctionPhotograph;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if (rootView == null) {
            ...
            mChatFunctionPhoto = (TextView) rootView.findViewById(R.id.chat_function_photo);
            mChatFunctionPhotograph = (TextView) rootView.findViewById(R.id.chat_function_photograph);
            mChatFunctionPhoto.setOnClickListener(this);
            mChatFunctionPhotograph.setOnClickListener(this);
        }
        return rootView;
    }
