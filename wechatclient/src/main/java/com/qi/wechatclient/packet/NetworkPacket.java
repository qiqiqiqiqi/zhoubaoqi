...
//	}
    ...
    public static void showPacket(IoSession ioSession, byte[] byteArray) {
//		try {
//			Log.d("Server send packet to client(" + ServerModel.getIoSessionKey(ioSession) + "); MessageType : "
...
//		}
    ...
    public byte[] getMessageTypeBytes() throws IOException {
        return DataTypeTranslater.intToByte(getMessageType().getNumber());
    }
