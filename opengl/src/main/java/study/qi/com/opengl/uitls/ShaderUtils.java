 ...
 */
package study.qi.com.opengl.uitls;
...
public class ShaderUtils {
    ...
    public static int createProgram(String vertexSource, String fragmentSource) {
        Log.d(TAG, "createProgram():vertexSource=" + vertexSource + ",fragmentSource=" + fragmentSource);
        ...
        Log.d(TAG, "createProgram():vertexShader=" + vertex + ",fragColorShader=" + fragment + ",program=" + program);
        return program;
    }

    public static int createProgram(Resources res, String vertexRes, String fragmentRes) {
        Log.d(TAG, "createProgram():vertexRes=" + vertexRes + ",fragmentRes=" + fragmentRes);
